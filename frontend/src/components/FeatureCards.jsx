...
const features = [
  {
    ...
    color: '#4A8FE7',
    iconBg: '#e8f1ff',
    shadow: 'rgba(74,143,231,0.15)',
    topBar: 'linear-gradient(90deg, #4A8FE7, #74aaef)',
    title: '구인 등록하기',
    desc: '간편하게 구인공고를\n등록해보세요',
  },
  {
    ...
    topBar: 'linear-gradient(90deg, #06b6d4, #38d4ea)',
    title: '지원자 확인',
    desc: '지원한 인재의 이력서를\n바로 확인할 수 있어요',
  },
  {
  ...
  },
  {
    ...
    topBar: 'linear-gradient(90deg, #8b5cf6, #a78bf8)',
    title: '맞춤 인재 추천',
    desc: '내 조건에 맞는\n우수 인재를 추천받으세요',
  },
]
