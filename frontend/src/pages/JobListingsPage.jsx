        ...
        <div className="jl2-body">
          <div className="jl2-body-inner">
            ...
            <aside className={`jl2-filter${filterOpen ? ' jl2-filter--open' : ''}`}>
              ...
              <div className="jl2-filter-header" onClick={() => setFilterOpen(v => !v)}>
                <span className="jl2-filter-title">
                  ...
                  필터
                  <svg
                    className={`jl2-filter-desktop-chevron${filterOpen ? ' open' : ''}`}
                ...
                <button className="jl2-filter-reset" onClick={e => { e.stopPropagation(); clearAll() }}>
