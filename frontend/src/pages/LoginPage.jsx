          ...
          {userType === 'personal' && (
            <>
              ...
              <div className="lp-social-btns">
                <button className="lp-social-btn lp-social-naver" onClick={() => window.location.href = '/oauth2/authorization/naver'}>
                  <span className="lp-social-logo">N</span>
                  네이버 로그인
                </button>
                <button className="lp-social-btn lp-social-kakao" onClick={() => window.location.href = '/oauth2/authorization/kakao?t=' + new Date().getTime()}>
                  <span className="lp-social-logo">K</span>
                  카카오 로그인
                </button>
                <button className="lp-social-btn lp-social-google" onClick={() => window.location.href = '/oauth2/authorization/google'}>
