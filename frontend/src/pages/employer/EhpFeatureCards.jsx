...
const ACTIONS = [
  {
    label: '구인공고 등록', color: '#4A8FE7', bg: '#EFF5FF', path: '/jobs/post',
  ...
  {
    label: '지원자 확인', color: '#E75480', bg: '#FFE8F2', path: '/applicants',
  ...
  {
    label: '채용 관리', color: '#27AE60', bg: '#E8F7EE', path: '/manage',
  ...
  {
    label: '인재 검색', color: '#9B59B6', bg: '#EEE0FF', path: '/talents',
  ...
  {
    label: '찜한 인재', color: '#e04444', bg: '#FFE5E5', path: '/wishlist',
